...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('project_fullname', type=str, nargs='?', default=None)
    ...
    def handle(self, *args, **options):
        ...
        if project is None:
            print("No project with fullname of {} is found".format(project_fullname))
        else:
            ...
            for build_result in builds_result:
                ...
                print("%s %d/%d/%d %d/%d" % (build.get("version"), build_number.get("number_passed"), build_number.get("number_failed"), build_number.get("number_total"), build_number.get("modules_done"), build_number.get("modules_total")))